...
_HERMES_CORE_TOOLS = [
    ...
    # Multi-agent operating system: PAL compiler, NPAO orchestrator,
    # RAG DAL knowledge engine, and Rostr Hub state management.
    "pal_compile", "npao_classify", "ragdal_search", "rostr_hub", "rostr_pipeline",
]
